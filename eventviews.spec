...
Version  : 20.12.0
Release  : 29
URL      : https://download.kde.org/stable/release-service/20.12.0/src/eventviews-20.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/eventviews-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/eventviews-20.12.0.tar.xz.sig
...
%prep
%setup -q -n eventviews-20.12.0
cd %{_builddir}/eventviews-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607918872
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/eventviews-20.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/eventviews/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/eventviews-20.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/eventviews/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5EventViews.so.5.16.0
