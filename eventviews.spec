...
%prep
%setup -q -n eventviews-24.02.1
cd %{_builddir}/eventviews-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711234468
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6EventViews.so.6.0.1
/usr/lib64/libKPim6EventViews.so.6
/usr/lib64/libKPim6EventViews.so.6.0.1
