...
Version  : 22.08.0
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.0/src/eventviews-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/eventviews-22.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.0/src/eventviews-22.08.0.tar.xz.sig
...
%prep
%setup -q -n eventviews-22.08.0
cd %{_builddir}/eventviews-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661787902
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5EventViews.so.5.21.0
