...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/eventviews-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/eventviews-22.12.1.tar.xz.sig
...
%prep
%setup -q -n eventviews-22.12.1
cd %{_builddir}/eventviews-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673450079
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5EventViews.so.5.22.1
