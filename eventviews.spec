...
%prep
%setup -q -n eventviews-20.04.0
cd %{_builddir}/eventviews-20.04.0
...
cp %{_builddir}/eventviews-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/eventviews/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5EventViews.so.5.14.0
