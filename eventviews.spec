...
Version  : 25.04.1
Release  : 119
URL      : https://download.kde.org/stable/release-service/25.04.1/src/eventviews-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/eventviews-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/eventviews-25.04.1.tar.xz.sig
...
%setup -q -n eventviews-25.04.1
cd %{_builddir}/eventviews-25.04.1
pushd ..
cp -a eventviews-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747235435
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6EventViews.so.6.4.1
/usr/lib64/libKPim6EventViews.so.6
/usr/lib64/libKPim6EventViews.so.6.4.1
